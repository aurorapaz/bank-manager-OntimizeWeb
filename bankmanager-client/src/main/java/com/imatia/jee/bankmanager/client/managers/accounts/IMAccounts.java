...
public class IMAccounts extends BasicInteractionManagerExpanded {
   ...
   @FormComponent(attr="OFFICEID") protected MaskDataField officeMask;
   @FormComponent(attr="ENTITYID") protected MaskDataField entityMask;
   @FormComponent(attr="OFFICEID_COMBO") protected ReferenceExtDataField officeCombo;
